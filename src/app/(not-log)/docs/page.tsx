...
export default function PageDocument() {
  return (
    <>
        ...
        <ul >
          <li><FaCheck/>Inicia sesión en tu cuenta.</li>
          <li><FaCheck/>Ve a la sección "Crear Proyecto".</li>
          <li><FaCheck/>Rellena los detalles del proyecto, como el nombre, la descripción y la categoría(si no esta la puedes agregar).</li>
          <li><FaCheck/>Confirma la creación del proyecto.</li>
        </ul>
        ...
        <ul>
          <li><FaCheck/>Ve a la sección "Gestión de Documentos" dentro del proyecto.</li>
          <li><FaCheck/>Agrega documentos existentes o crea nuevos.</li>
          <li><FaCheck/>Edita los documentos según sea necesario.</li>
          <li><FaCheck/>Asigna colaboradores para que puedan acceder y editar los documentos relevantes</li>
        </ul>
        ...
        <ul>
          <li><FaCheck/>En la página del proyecto, ve a la sección "Colaboradores".</li>
          <li><FaCheck/>Invita a usuarios por su nombre de usuario o dirección de correo electrónico.</li>
        </ul>
        ...
        <ul>
          <li><FaCheck/>Abre el documento en el que deseas comentar.</li>
          <li><FaCheck/>Escribe tus comentarios en la sección de comentarios.</li>
          <li><FaCheck/>Discute ideas, proporciona retroalimentación y colabora con otros usuarios en el documento. </li>
        </ul>
